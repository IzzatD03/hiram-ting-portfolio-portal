  ...
  const otherSections = [
    {
      ...
      items: [
        { id: 1, title: 'Director', organization: 'Centre for Responsible Borneo (REBORN)', period: '' },
        ...
        { id: 4, title: 'Academic Advisory Board', organization: 'East Asia Inter-Regional Tourism Federation (EATOF)', period: '' },
        { id: 5, title: 'Director', organization: 'Southeast Asia Research Academy (SEARA)', period: '' },
